...
Refer Tensorflow examples and face recognizer project in Github (See [Reference](#reference)) 

Refer FaceNet paper to understand why we use this model in PHODO Application. (See [Reference](#reference))
