...
package com.example.phodo.facerecognizer.tracking;
...
import com.example.phodo.facerecognizer.Recognizer.Recognition;
...
public class MultiBoxTracker {
    ...
    protected Matrix frameToCanvasMatrix;
    ...
    public synchronized void draw(final Canvas canvas, final Integer facing) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            // 해당 디바이스 화면 기준 얼굴 확률값 대입!!
            faceConfidence = recognition.detectionConfidence;

//            canvas.drawRoundRect(trackedPos, cornerSize, cornerSize, boxPaint);
//            borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString);
            if(facing == 1) {
                canvas.drawRoundRect(trackedPos, cornerSize, cornerSize, boxPaint);
                canvas.drawCircle(trackedPos.centerX(), trackedPos.centerY(), 1f, boxPaint);
                borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString);
            }else{
//                canvas.drawRoundRect(trackedPos, cornerSize, cornerSize, boxPaint);
//                borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString);
                canvas.drawRoundRect(1100 - trackedPos.right, trackedPos.top, 1100 - trackedPos.left, trackedPos.bottom, cornerSize, cornerSize, boxPaint);
                borderedText.drawText(canvas, 1100 - (trackedPos.left + cornerSize), trackedPos.bottom, labelString);
            }
        }
    }
