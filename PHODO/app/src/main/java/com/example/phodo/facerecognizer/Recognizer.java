...
import com.example.phodo.facerecognizer.ml.FaceNet;
import com.example.phodo.facerecognizer.ml.LibSVM;
...
public class Recognizer {
    List<Recognition> results = new LinkedList<Recognition>();
    /**
